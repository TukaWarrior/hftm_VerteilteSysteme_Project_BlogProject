...
public class StartupBean {
    ...
    public void init() {
        ...
        accountService.addAccount(new Account(null, "Alice", "alice@email.com", "admin", ZonedDateTime.now()));
        accountService.addAccount(new Account(null, "Brian", "brian@email.com", "moderator", ZonedDateTime.now()));
